 ...
 */
const envBaseUrl = import.meta.env.VITE_API_BASE_URL || "http://127.0.0.1:5001/digital-catalog-saas/us-central1/api";
...
function getEffectiveBaseUrl(): string {
  ...
  if (typeof window !== "undefined") {
    try {
      if (envBaseUrl.startsWith("http://127.0.0.1:5001") || envBaseUrl.startsWith("http://localhost:5001")) {
